CREATE OR REPLACE FUNCTION lsm_idx_handler(internal)
RETURNS index_am_handler
AS 'MODULE_PATHNAME'
LANGUAGE C;

CREATE ACCESS METHOD lsm_idx TYPE INDEX HANDLER lsm_idx_handler;

CREATE OPERATOR FAMILY integer_ops USING lsm_idx;

CREATE OPERATOR CLASS int2_ops DEFAULT
	FOR TYPE int2 USING lsm_idx FAMILY integer_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS int4_ops DEFAULT
	FOR TYPE int4 USING lsm_idx FAMILY integer_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS int8_ops DEFAULT
	FOR TYPE int8 USING lsm_idx FAMILY integer_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
ALTER OPERATOR FAMILY integer_ops USING lsm_idx ADD
...
CREATE OPERATOR FAMILY float_ops USING lsm_idx;

CREATE OPERATOR CLASS float4_ops DEFAULT
	FOR TYPE float4 USING lsm_idx FAMILY float_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS float8_ops DEFAULT
	FOR TYPE float8 USING lsm_idx FAMILY float_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
ALTER OPERATOR FAMILY float_ops USING lsm_idx ADD
...
CREATE OPERATOR CLASS bool_ops DEFAULT
	FOR TYPE bool USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS bpchar_ops DEFAULT
	FOR TYPE bpchar USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS bytea_ops DEFAULT
	FOR TYPE bytea USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS char_ops DEFAULT
	FOR TYPE "char" USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR FAMILY datetime_ops USING lsm_idx;

CREATE OPERATOR CLASS date_ops DEFAULT
	FOR TYPE date USING lsm_idx FAMILY datetime_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS timestamp_ops DEFAULT
	FOR TYPE timestamp USING lsm_idx FAMILY datetime_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS timestamptz_ops DEFAULT
	FOR TYPE timestamptz USING lsm_idx FAMILY datetime_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
ALTER OPERATOR FAMILY datetime_ops USING lsm_idx ADD
...
CREATE OPERATOR CLASS interval_ops DEFAULT
	FOR TYPE interval USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS macaddr_ops DEFAULT
	FOR TYPE macaddr USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS numeric_ops DEFAULT
	FOR TYPE numeric USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR FAMILY text_ops USING lsm_idx;

CREATE OPERATOR CLASS text_ops DEFAULT
	FOR TYPE text USING lsm_idx FAMILY text_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS name_ops DEFAULT
	FOR TYPE name USING lsm_idx FAMILY text_ops AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
ALTER OPERATOR FAMILY text_ops USING lsm_idx ADD
...
CREATE OPERATOR CLASS time_ops DEFAULT
	FOR TYPE time USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS timetz_ops DEFAULT
	FOR TYPE timetz USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS money_ops DEFAULT
	FOR TYPE money USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
...
CREATE OPERATOR CLASS uuid_ops DEFAULT
	FOR TYPE uuid USING lsm_idx AS
	OPERATOR 1  <,
	OPERATOR 2  <=,
	OPERATOR 3  =,
	OPERATOR 4  >=,
